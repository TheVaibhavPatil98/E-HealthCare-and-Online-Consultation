...
public class DocumentDao {
	...
	public void addDocument(Patient patient,String type,String date,String fileName,String appointmentLink,String description,Blob file) {

		Document doc = new Document();
		doc.setPatient(patient);
		doc.setDocumentDescription(description);
		doc.setAppointmentLink(appointmentLink);
		//doc.setAppointmentTime(appointmentTime);
