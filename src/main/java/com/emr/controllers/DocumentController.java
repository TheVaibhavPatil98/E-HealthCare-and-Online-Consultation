...
public class DocumentController {
	...
	public String addDocument(HttpServletRequest request, @RequestParam String documentType,@RequestParam String documentDate,@RequestParam String description,@RequestParam("file") MultipartFile file, @RequestParam String appointmentLink){
		...
		try {
			...
			dao.addDocument(patient,documentType,documentDate,fileName,description,appointmentLink,blob);
