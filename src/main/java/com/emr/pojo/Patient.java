...
public class Patient {
	...
	public Patient(String firstName, String lastName, String gender, Date dateOfBirth, String phoneNo, String address,
			String bloodGroup, String loginId, String password, Blob profilePhoto, String emailId) {
