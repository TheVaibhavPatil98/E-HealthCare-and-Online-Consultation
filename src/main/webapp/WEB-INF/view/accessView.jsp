...
<body>
	<div style="text-align: center;">
		<%
		List<AccessDto> list = (List<AccessDto>) request.getAttribute("list");
		if (list == null) {
		%>
											...
											<div class="card shadow-sm">
												...
												<div class="card-body pt-0">
													<table class="table">
														...
														<tbody>
															<%
															for (AccessDto li : list) {
															
																
															%>
															<tr>
																<td><%= li.getId() %></td>
																<td><%= li.getPatientName() %></td>
																<td><%= li.getStatus() %></td>
													...
													<div style="text-align: center;">
														<form action="doctor_view_patient" method="POST">

															<strong>Enter PatientId to view Patient: </strong> <input
																style="border: 2px solid black; border-radius: 4px;"
																type="text" name="accessId" />
