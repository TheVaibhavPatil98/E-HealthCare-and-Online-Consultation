				...
				<div class="card-body">
					...
					<form action="add_patient" method="POST"
							...
							<div class="col-6">
								<div class="input-group">
									<label class="label">First Name</label> <input
										class="input--style-4" type="text" name="firstName" required>
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
									<label class="label">Last Name</label> <input
										class="input--style-4" type="text" name="lastName" required>
								</div>
							</div>
						</div>
						<div class="row row-space">
						...
						<div class="row row-space">
							...
							<div class="col-6">
								<div class="input-group">
									<label class="label">Contact No</label><br> <input
										class="input--style-4" type="text" name="contactNo" required>
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
									...
									<textarea class="input--style-4" rows="2" cols="20"
							...
							<div class="col-6">
								<div class="input-group">
									<label class="label">Blood Group</label> <input
										class="input--style-4" type="text" name="bloodGroup" required>
								</div>
							</div>
							<div class="col-5">
								<div class="input-group">
									<label class="label">User Name</label> <input
										class="input--style-4" type="text" name="uname" required>
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
