...
<!-- Title Page-->
<title>Register Forms For Doctor</title>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<ul class="navbar-nav">
						...
						<li><a class="nav-link" href="/doctor_login">Login</a></li>
				...
				<div class="card-body">
					...
					<form action="add_doctor" method="POST"
						...
						<div class="row row-space">
							<div class="col-5">
								<div class="input-group">
									<label class="label">Experience</label> <input
										class="input--style-4" type="text" name="experience">
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
									...
									<div class="p-t-10">
										<br> <label class="radio-container m-r-45">Male <input
						...
						<div class="row row-space">
							<div class="col-6">
								<div class="input-group">
									<label class="label">Email ID</label> <input
										class="input--style-4" type="email" name="email">
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
									<label class="label">Contact No</label><br> <input
										class="input--style-4" type="text" name="contact">
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
									<label class="label">Education</label> <input
										class="input--style-4" type="text" name="education">
								</div>
							</div>
							<div class="col-6">
								<div class="input-group">
									<label class="label">Specialization </label> <input
										class="input--style-4" type="text" name="specialization">
								</div>
							</div>
							<div class="col-5">
								<div class="input-group">
							...
							<div class="col-8">
								<div class="input-group">
									<label class="form-label" for="customFile">Profile
										Photo</label> <br /> <input type="file" class="form-control"
										id="customFile" name="file" accept="image/png, image/jpeg" />
								</div>
							</div>
						</div>
						...
						<div class="p-t-15" style="text-align: center;">
							<button class="btn btn--radius-2 btn--blue" type="submit">Sign
								Up</button>
						</div>
