...
<body id="home" data-spy="scroll" data-target="#navbar-wd"
	...
	<div class="container">
		<div class="row">
								...
								<div class="col-8">
									...
									<p class="mb-0">
										<span class="fw-bold">Product:</span><span class="c-green">:
											Name of product</span>
									</p>
									<p class="mb-0">
										<span class="fw-bold">Price:</span><span class="c-green">:R-500/-</span>
									</p>
									<p class="mb-0">Frail elderly syndrome (Nursing care Plan),
										Risk for frail elderly syndrome Deficient community health,
										Risk-prone health behaviour Ineffective health maintenance
										(Nursing care Plan), Ineffective health management Readiness
										for enhanced health management, Ineffective family health
										management, Ineffective protection.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="card-body border p-0">
						<p>
							<a
								...
								data-bs-toggle="collapse" href="#collapseExample" role="button"
								aria-expanded="true" aria-controls="collapseExample"> <span
								class="fw-bold">Credit Card</span> <span class=""> <span
						...
						<div class="collapse show p-3 pt-0" id="collapseExample">
							<div class="row">
								<div class="col-lg-5 mb-lg-0 mb-3">
									...
									<p class="mb-0">
										<span class="fw-bold">Price:</span> <span class="c-green">:Rs-500/-</span>
									</p>
									<p class="mb-0">Frail elderly syndrome (Nursing care Plan),
										Risk for frail elderly syndrome Deficient community health,
										Risk-prone health behaviour Ineffective health maintenance
			...
			<div class="col-12">
				<div><a class="btn btn-primary payment" href="/paydone">Make Payment</a></div>
			</div>
		</div>
	</div>
	<!-- Start Footer -->
