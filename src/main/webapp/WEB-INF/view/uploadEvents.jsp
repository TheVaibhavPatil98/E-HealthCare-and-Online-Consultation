	...
	<div class="main-top">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="left-top">
						<a class="new-btn-d br-2" href="#"><span>E-HealthCare</span></a>
					</div>
				</div>
				<div class="col-lg-6">
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<ul class="navbar-nav">
						...
						<li><a class="nav-link" href="index">LogOut</a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	<div class="container-login100">
        <div class="wrapper wrapper--w680">
            <div class="card card-5">
                <div class="card-body">
                    <h2>New Event</h2>
                	<small class="text-muted">Add New Event.</small>
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                         <br>
                                        <input class="input--style-4 js-datepicker" type="date" name="eventDate">
                                 ...
                                 <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-line">
                                                <textarea rows="4" cols="3" name="description" class="form-control no-resize auto-growth"></textarea>
                                            </div>
                                        </div>
                                    </div>
