						...
						<div class="row row-space">
								...
								<div class="form-group" style="position: relative;">
									...
									<div class="form-line">
										<input type="file" name="file" class="form-control"
											accept="image/gif, image/png, image/jpg, image/jpeg,application/pdf,application/vnd.ms-excel"
							...
							<div class="col-6">
								<div class="input-group">
									...
									<div class="input-group-icon">
										<input type="url" id="appointmentLink" name="appointmentLink" style="width: 300px"
